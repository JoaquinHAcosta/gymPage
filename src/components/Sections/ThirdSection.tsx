...
export const ThirdSection = () => {
  return (
    <section className="h-[80vh] md:h-[120vh] w-full  bg-[rgb(3,12,20)] md:bg-[linear-gradient(0deg,_rgba(3,12,20,1)_88%,_rgba(255,255,255,1)_88%)]">
      <div className="max-w-[1350px] mx-auto">
        <div className="hidden md:block h-[300px] w-[80%] mx-auto border-8 border-red-600 text-white">
          Aca video
        </div>
